...
| `seeds/21_vulk_stray_complete.sql` | ⏳ pendiente | Complete Vulk Stray post-seed 20. **UPDATE producto**: agrega attributes faltantes (frame_material g-flex, frame_shape rectangular, gender unisex, size large, weight 36.5g, hinge_system flex-metal, lens_type demo, compatible_lens_types [monofocal,bifocal,progresivo], measurements 144/52/46/20/145). Description expandida con detalle G-Flex + bisagras Flex metálicas + lente Demo + compatibilidad lentes graduadas. **INSERT 5ta variante CRY (Transparente)** — confirmado por founder que ML la lista como "Gris" pero es transparente. Variation ML 185252770949, stock 5, price $93.000. **⚠️ SKU PLACEHOLDER 126892** — founder debe confirmar el SKU real (no lo pasó). + 2 imágenes (10-cry-lateral.jpg, 11-cry-frontal.jpg). Aplicar DESPUÉS de seed 20. |
