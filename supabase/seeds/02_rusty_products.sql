...
VALUES
  ...
  (
    ...
    '{"frame_material": "metal", "frame_shape": "aviator", "lens_treatment": ["gradient", "uv400"], "gender": "unisex"}'::jsonb,
    true,
    false,
  ...
  (
    ...
    '{"frame_material": "acetate", "frame_shape": "round", "gender": "unisex"}'::jsonb,
    true,
    false,
  ...
  (
    ...
    '{"frame_material": "acetate", "frame_shape": "square", "gender": "unisex"}'::jsonb,
    true,
    false,
