...
VALUES (
  ...
  E'⚠️ IMPORTANTE: los Rusty Misty son de **talle chico** — un armazón pequeño, pensado para **rostros chicos o angostos**. Si tenés un rostro mediano o grande, probablemente te queden chicos. Mirá bien las medidas antes de comprar (frente 132 mm).\n\nSon anteojos de sol REDONDOS unisex, con frente y patillas de G-Flex y **bisagras metálicas Flex customizadas** para una apertura firme y durable. Con solo 17,8 gramos son de los más livianos del catálogo.\n\nLas lentes son de policarbonato con protección UV400 categoría 3 (100% UVA/UVB).\n\nDisponible en 3 variantes:\n\n• L.ROSE/GS9B (SKU 125739): armazón rosa transparente con lente verde degradé.\n• BROWN/UB18 POL (SKU 127032): marrón transparente con lente marrón POLARIZADA.\n• MBLK/S10 POL (SKU 127030): negro mate con lente gris oscuro POLARIZADA.\n\nIncluye estuche original, franela de microfibra y garantía oficial de 1 año del fabricante.',
  '{
