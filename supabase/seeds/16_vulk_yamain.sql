...
VALUES (
  ...
  'vulk-yamain',
  'Vulk Yamain',
  'Anteojos de sol ovalados grandes para mujer. Armazón G-Flex liviano con bisagras Flexo, lentes policarbonato UV400. Disponible con lente clásica o polarizada.',
  E'Los Vulk Yamain son anteojos de sol ovalados grandes pensados para mujer. Forma envolvente que cubre desde la ceja hasta el pómulo, líneas suaves que resaltan los rasgos sin endurecer la cara — el lenguaje estético femenino contemporáneo.\n\nEl armazón es de G-Flex (termoplástico flexible patentado por Vulk): aguanta caídas, torsiones y uso intensivo mejor que un acetato tradicional. Combinado con el sistema de bisagras Flexo, las patillas absorben presión lateral sin romperse — útil si las llevás en bolso o cartera todo el día.\n\nLos lentes son de policarbonato con filtro UV400 (bloquean 100% UVA y UVB). El policarbonato es más liviano que el cristal y resistente al impacto. El conjunto pesa solo 30,9 gramos, casi imperceptible durante el día.\n\nTres opciones de color: armazón transparente con lentes gris degradé (CRY), negro mate con lentes gris oscuro (MBLK), y la versión polarizada con armazón negro brillo y lentes gris degradé polarizadas (SBLK). La polarizada elimina los reflejos molestos del agua, asfalto y vidrio — ideal si conducís de día, vas a la playa o pasás tiempo cerca del agua.\n\nTalle Large (146mm de frente x 55mm de altura). Pensados para rostros de tamaño mediano a grande. Si tenés rostro chico o muy chico, el modelo puede quedar grande — consultanos antes de comprar y te orientamos.\n\nIncluye estuche original Vulk, franela de microfibra y garantía oficial 1 año del fabricante contra defectos.',
  '{
    ...
    "callouts": [
      ...
      },
      {
        "type": "recommendation",
        "position": "middle",
        "title": "¿Polarizadas (SBLK) o clásicas (CRY/MBLK)?",
        "body": "Polarizadas si conducís de día, vas a la playa, pesca, o trabajás cerca del agua — eliminan reflejos que cansan la vista. Clásicas si las usás casual urbano: igual protección UV400, menos costo. Las dos opciones tienen el mismo filtro 100% UVA/UVB."
      },
      {
        "type": "tip",
        "position": "bottom",
