...
- [ ] **Peso (`weight_grams`) de Vulk Tour 81** (deuda de carga 2026-06-11). ML no especifica el peso → se cargó sin él, el casillero "Peso" del comparador queda vacío. El founder tiene la unidad física (315, stock 1) → pesarla y agregar `weight_grams` al seed 62 + DB. (Patrón general: si ML no da peso, queda pendiente pesar.)
