...
- [ ] **Dinamizar framer-motion** (audit perf 2026-06-11). ~60kB gzipped en el bundle inicial de todas las páginas; lo importan 15+ componentes, varios no-críticos (FloatingWhatsapp, BackToTop, ScrollProgress). Mitigación: `next/dynamic` desde un wrapper client, o migrar los triviales a CSS. Medir con bundle analyzer antes.
