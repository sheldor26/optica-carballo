...
🟢 **AJUSTE FINO SCALE The Trial (2026-06-14, founder en el grid)**. SOL: V2 MBLK 053/S15 antifog perfil 1.0→1.08; V1/V3/V4 perfil 1.0→1.03. RECETA: ambas perfil 1.0→1.03. Solo perfiles (foto del card), frentes en 1.0 (criterio Marky Ramone). Cambio de valores en `image-scale-overrides.ts`.
