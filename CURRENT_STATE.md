...
🟢 **SCALE Spell receta −0.1 (2026-06-29)**. Founder: el Spell receta se veía muy grande vs el resto del grid de receta → perfiles 1.2 → 1.1 (frentes 1.05). Cambio en `image-scale-overrides.ts`.
