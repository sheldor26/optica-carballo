...
🟡 **Carga Rusty Vorez (sol, cuadrado femenino, 2 variantes) — EN CURSO, bloqueada por input founder** (2026-06-02). Data ya levantada de ML (prod endpoint), NO re-fetchear:
- SBLK/S10 POL — MLA2007542724 — $76.500 — stock 0 (pausada) — **POLARIZADA**.
- MROSE/HGB1 — MLA2052436076 — $69.808,65 — stock 5 (activa) — NO pol (antirreflex, marrón degradé).
- Specs: G-Flex, bisagras plásticas, policarbonato UV400 cat3, **femenino, cuadrado**, 25,5g. Medidas 141 / 51x52 / 17 / 145. 1 de 2 pol → `lens_treatment ["uv400"]`.
- Fotos (del screenshot, prefijo AGALERIA igual que Beason; NO subidas aún al bucket): `VOREZ GALERIA-WEB-SBLK-S10-POL perfil.jpg` / `VOREZ AGALERIA-WEB-SBLK-S10-POL frente.jpg` / `VOREZ GALERIA-WEB-MROSE-HGB1 Perfil.jpg` / `VOREZ AGALERIA-WEB-MROSE-HGB1 frente.jpg`.
- **⛔ BLOQUEANTES**: (1) faltan los 2 SKUs (no vienen en ML ni los pasó el founder); (2) las fotos NO están en el bucket (`storage.objects ILIKE '%vorez%'` → vacío) — falta subirlas a `rusty-vorez/`. Apenas haya SKUs + fotos: armar seed 45, aplicar MCP, scale 1.15/1.0, docs.
