...
🟢 **AJUSTE SCALE Rusty The Take SOL (2026-07-01)**. Founder pidió agrandar el The Take en el grid de `/anteojos-de-sol`. Solo tiene 1 variante (L.GREY-MBLK), foto 900×442. Subí `rusty-the-take/THE_TAKE_L.GREY-mblk_s10_pol_-_p.jpg` (perfil) de **1.0 → 1.15** en `lib/catalog/image-scale-overrides.ts`. Frente queda en 1.0. Visible tras ISR. Commit local pendiente. **Próximo exacto**: founder chequea scale en grid; ajustar si hace falta.
