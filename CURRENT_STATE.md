...
🟢 **SCALE grid receta emparejado (2026-06-29)**. Founder: el Spell se veía grande vs el resto. Decisión final (cambió de "achicar Spell" a "agrandar los otros"): **Spell, Ther y The Take perfiles todos en 1.1** (Spell 1.2→1.1; Ther y The Take 1.0→1.1; frentes sin cambio). Quedan parejos en el grid de receta. Woxi sigue en 1.2 (founder no lo mencionó). Commits 849e2f4 + d373f3b. `image-scale-overrides.ts`.
