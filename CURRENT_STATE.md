...
**(C) Swipe/Match tras login** [feature, a planear]: pedir login al usar Swipe → guardar el modelo del match en la cuenta (capturar mail/datos para mails de marketing personalizados). Decisión: gate duro (antes de usar) vs blando (al guardar match) — conversion-optimizer.
