...
- **✅ AQ31 RESUELTO**: es una 5ta variante (663-056 / AQ31). MLA1904276470 es **multi-variación** (contiene 669k-068/CH79 var 186030898413 stock 1 + AQ31 var 193275243101 stock 6). Mapeo completo de las 5: MBLK/S10 125187 (MLA2493352472, stock 1, pol), 669k/CH79 125188 (MLA1904276470 var ...413, stock 1), SBLK-206/118 125189 (MLA2683652154, stock 0), SBLK-068/902 125180 (MLA1957668976, stock 0), AQ31 663-056 (MLA1904276470 var ...101, stock 6, SKU ???). Solo MBLK/S10 polarizada → `lens_treatment ["uv400"]`.
- **⚠️ Falta 1 (SKU AQ31)**: las 4 listadas tienen SKU 12518x; AQ31 no lo dio (ML no lo expone) → esperando SKU numérico (no inventar para no colisionar).
- **⚠️ Falta 2 (1 filename con `/`)**: el founder renombró casi todos PERO quedó `Biller SBLK 068/902 perfil.jpg` con `/` → debe renombrarlo sin barra. Resto de nombres OK (con espacios/dobles espacios, tolerables).
- **Próximo paso**: founder pasa SKU de AQ31 + renombra el 068/902 → seed 41 + MCP (multi-variación con variation codes) + scale + docs. Stock = ML.
