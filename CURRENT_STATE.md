...
- **⬜ FALTA antes de escribir**: (b) **founder ratifica** los 12 puntos del brief técnico; (c) **regente firma** los 7 clínicos (🩺) + confirma umbral "miopía alta" (−6.00 D ref) e inicio presbicia (40-45). Con (b)+(c) → `content-writer-medical` escribe la pillar Astigmatismo.
