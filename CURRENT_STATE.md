...
- **Esvep scale iter 6**: perfil 1.5 / frente 1.25 (1.6→2.0→1.8→1.7→1.6→"-0.1 más"→1.5. En código, esperando validación. Foto 1000×491 2:1, anteojo chico en el frame).
- **Dileri scale iter 3**: perfil 1.15 / frente 1.0 (iter 2 era 1.25/1.1; founder "-0.1 en todos los grids" 2026-06-05. En código, esperando validación).
