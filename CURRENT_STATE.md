...
🟢 **RUSTY PATIEN SOL CARGADO (2026-06-13)**. Anteojos de SOL wayfarer **UNISEX**, **bisagras metálicas flex** (≠ Play/Terdey plásticas), 4 colores (seed 65, `rusty-patien`). Norma cumplida: seo-strategist + catalog-loader. 4 MLAs separados, data ML: SBLK/S15 $73.661 stock 17 (primary, antirreflex), Revo Blue $79.373 stock 13 (espejada), MBLK/S10 POL $85.924 stock 6 (única POL→/polarizados), 669K/SBLK $86.011 stock 0 (sin polarizar, bicolor gris-transparente/negro; cargado activo por regla "todas aunque 0"). Solo 1/4 polarizada → meta NO afirma "polarizados" de modelo (honestidad, como Play). Medidas 140/49×40/21/145 (foto). frame_shape wayfarer, gender unisex. Scale **1.2/1.05** (fotos 1200×589, anteojo ~70% → zona My Crew/Tour 81; el catalog-loader frenó el 1.3/1.15 que el founder ya reportó "grande" 3 veces). PDP 200, fotos 200, typecheck OK. Bloque agregado al cluster SEO con anti-canibalización (Patien unisex+branded, Terdey polarizado-de-modelo, Play hombre). **Default global SOL aplicado** (founder 2026-06-13): cat 3 + policarbonato + 100% UV por defecto salvo aclaración — ver memoria [[default-sol-cat3-policarbonato-uv]]. **⬜ Pendiente founder**: redeploy + ver grillas + pesar (lista BACKLOG: Tour 81, Play, Terdey, Patien). **Próximo**: siguiente producto o lo que pida.
