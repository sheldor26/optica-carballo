...
🟢 **Producto Rusty Esvep (sol, envolvente deportivo, polarizado) — APLICADO PARCIAL (2 de 3 var)** (2026-06-05). Seed `58_rusty_esvep.sql` aplicado vía MCP + verificado runtime (PDP 200, en /deportivos + /polarizados). 2 variantes POL cargadas (datos limpios): MBLK/S10 POL 112884 $76.194 stock 7 (primary); SBLK/S10 POL 112881 $76.194 stock 5. Ambas pol → entra a /polarizados. frame_shape envolvente → aparece en /deportivos. G-Flex, bisagras plásticas reforzadas, cat 3, UV400, medidas 140/60×46/10/130. Scale baseline 1.15/1.0 (envolvente, probable bump). Verificación MCP: `variantes=2, pol=2, stock=12, imgs=5, vars_sin_foto=0`. **⬜ PENDIENTE founder (3ª variante)**: SBLK/S10 **sin polarizar** (MLA1397700103, $66.724, stock 0 paused) NO cargada — founder pasó SKU 112881 DUPLICADO (= SBLK POL) y hay 2 archivos "SBLK S10 perfil" (2 vs 3 guiones) sin frente claro. Falta: SKU real + cuál foto es perfil/frente. + chequeo visual scale.
