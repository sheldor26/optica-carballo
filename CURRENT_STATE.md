...
🟡 **CARGA ABIERTA: Rusty Invig RECETA — producto+variantes APLICADOS, fotos pendientes (2026-07-07, seed 82)**. Verificación MCP: `forma=rectangular, gender=male, peso 14.7, variantes=3, stock=6, skus 840071/840070/840072`. name "Rusty Invig Optics". Flow de norma cumplido (catalog-loader molde Zinz 78 + seo-strategist). **Bloque de imágenes NO aplicado** (bucket `rusty-invig-receta/` vacío) → producto sale con "Foto pendiente" hasta subir. Docs: seed 82 (completo, images marcadas carga abierta), CLOUD_APPLIED, PRODUCTS_INVENTORY, SEO_STRATEGY. **⚠️ SIN commitear/pushear**. **⬜ PENDIENTE FOUNDER**: (1) subir las 7 fotos a `rusty-invig-receta/` → yo engancho nombres exactos (C3 truncado en captura) + aplico bloque imágenes + scale 1.1/1.0 + verifico; (2) confirmar colores (ML C1 marrón/C3 gris oscuro vs fotos C1 BLUE/C3 PLATEADO — apliqué ML, "BLUE"=probable reflejo lente); (3) confirmar hero C2 negro + hinge_system "metalica" (acero inox en copy). Datos ML: 3 MLAs separados C2 MLA1878532277 / C1 MLA1878532279 / C3 MLA1878519921, todos $72.999→7299900c stock 2.
