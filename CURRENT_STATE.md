...
🟢 **VULK KATLEEN RECETA — +1 variante MDEMI (2026-06-15)**. Founder agregó la variante MDEMI (carey mate) al Katleen receta (ya cargado, misma multi-variante MLA2014157548). var 204547293605, $86.541,45, stock 3. ⚠️ ML sin SKU → placeholder KATLEEN-MDEMI (sync usa varcode). Inserté SOLO la variante + 2 imágenes (katleen-mdemi-P/F.jpg, HTTP 200) vía MCP, sin tocar las 3 existentes. Scale 1.15/1.0 (= resto del modelo). Seed 53 sincronizado + override + CLOUD_APPLIED. Verificación MCP: 4 variantes, 2 imgs c/u. ⬜ Sin commitear. **Próximo**: redeploy/ISR; o siguiente.
