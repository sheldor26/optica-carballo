...
- **Esvep scale iter 4 (FINAL)**: perfil 1.7 / frente 1.4 (1.6 chica → 2.0 muy grande → 1.8 → 1.7. Confirmado founder vía bracket, commit 7bb7895. Foto 1000×491 2:1, anteojo chico en el frame → más scale que Sotion/Eslav 1.6).
