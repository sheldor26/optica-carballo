...
🟡 **Producto Vulk Lady Piny (sol, redondo femenino, cat 3) — SEED LISTO, NO APLICADO** (2026-06-04). Seed `56_vulk_lady_piny.sql` + scale override (1.15/1.0). **BLOQUEADO esperando fotos**: `vulk-lady-piny/` vacío + CDN 400. 4 variantes simples (datos ML verificados): 285-UFC0096/GB10S 1194183 $90.584,21 stock 6 (primary, rosa); 292-UFQ0028/GS9B 1194182 $90.584,21 stock 6 (rosa pálido); SBLK-UFQ0003/SG16 1194180 $90.584,21 stock 3 (negro verde degradé); SBLK-UQ0178/BG26 1194181 $94.400 stock 0 paused (**POL**, marrón degradé). 1 de 4 pol → `lens_treatment ["uv400"]`. gender=female, 30,9g, **cat 3** (founder corrigió: primero dijo cat 4 → cat 3; saqué el callout warning de "no manejar"). Frente G-Flex + patillas acetato + **bisagras metálicas sistema flex** (founder corrigió de "acetato/flexo"). Medidas 141/57×54/17/135. frame_shape "redondo" (ML mezcla redondo/ovalado/"en puntas" — ⚠️ confirmar founder). **⬜ Próximo paso exacto**: founder sube las 9 fotos a `vulk-lady-piny/` → verifico CDN (casing: 285 usa "Frente" mayúscula) → aplico MCP → chequeo scale. + confirmar shape.
