...
- **Esvep scale iter 4**: perfil 1.7 / frente 1.4 (2.0/1.6 muy grande → 1.8/1.45 → "un poco más chico" → 1.7/1.4. Esperando validación founder. Foto 1000×491 2:1, anteojo chico en el frame → más scale que Sotion/Eslav 1.6).
