...
🔴 **2 SEEDS ESCRITOS, PENDIENTES APLICAR: Rusty Peating RECETA + SOL (2026-07-14, seeds 84+85)**. Par completo (sol + receta) del mismo armazón físico Rusty Peating, cuadrado unisex G-Flex, 18,9g, medidas 143/52×49/19/133 — **ninguno de los dos aplicado al cloud**: el MCP Supabase se desconectó a mitad de la carga del receta y siguió caído todo el turno (revalidado varias veces, confirmado que sigue caído). Ambos con flow de norma cumplido (catalog-loader + seo-strategist), typecheck OK, código commiteado.
