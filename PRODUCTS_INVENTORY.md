...
| Rusty: Dileri (cuadrado femenino, 2 var) | 1 | 2 (stock 6) | 0 (⚠️ bucket vacío, CDN 400) | 1 | 🟡 **Seed 55 LISTO, NO aplicado** — esperando fotos. 1 pol (SBLK/S10) → `lens_treatment ["uv400"]`. gender=female, 31,8g, 140/52×53/15/135. Frente G-Flex + patillas Flex Temple. Primary=SBLK/S10 POL. **Próximo: founder sube fotos → verifico CDN → aplico MCP → chequeo scale.** |
