...
| Rusty: CCCP (deportivo envolvente, unisex, 4 var) | 1 | 4 (stock 8; 3 con stock) | 5 (HTTP 200) | 1 | ✅ Aplicado MCP (seed 54). 2 pol (POL) + 2 antirreflex interno → `lens_treatment ["uv400"]`. Envolvente deportivo, G-Flex, 139/68×45/16/108. Primary=SBLK/S10 POL. **2 vars sin foto propia (esperado: founder subió 2 pares, modelo igual).** Scale 1.15/1.0 (puede necesitar bump, como Eslav). Founder: chequear scale. |
