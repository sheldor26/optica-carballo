...
| Vulk: Lady Piny (redondo femenino, 4 var) | 1 | 4 (stock 15; 3 con stock) | 0 (⚠️ bucket vacío, CDN 400) | 1 | 🟡 **Seed 56 LISTO, NO aplicado** — esperando fotos. 1 pol (BG26) → `lens_treatment ["uv400"]`. gender=female, 30,9g, cat 3, 141/57×54/17/135. G-Flex + acetato + bisagras metálicas flex. Primary=285 rosa. **Próximo: founder sube fotos → verifico CDN → aplico MCP → chequeo scale + confirmar shape.** |
