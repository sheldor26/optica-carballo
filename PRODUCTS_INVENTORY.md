...
| Vulk: Deserve (cuadrado grande, unisex, 3 variantes) | 1 | 3 (stock 15) | 0 (⚠️ bucket vacío, CDN 400) | 1 | 🟡 **Seed 51 LISTO, NO aplicado** — esperando fotos. 1 pol (MBLK/S10) → `lens_treatment ["uv400"]`. Talle large, 146/59×58/16/145. Primary=MBLK/S10 POL perfil. **Próximo: founder sube fotos a `vulk-deserve/` → verifico CDN → aplico MCP → chequeo scale.** |
