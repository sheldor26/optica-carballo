...
| Rusty: Gresent (aviador doble puente, unisex, 4 variantes) | 1 | 4 (stock 15) | 9 (HTTP 200) | 1 | ✅ Aplicado MCP (seed 49). Multi-variante, ninguna pol → `lens_treatment ["uv400"]`. Apto receta, aviador doble puente, 38,4g. Primary=SDEMI carey. Founder: confirmar medidas (webp 138/60/14 vs texto 128/50/18) + chequear grid. |
