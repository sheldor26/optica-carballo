...
|-------|-------------------|-----------|--------------|---------|--------|
| Rusty: Invig RECETA (rectangular hombre metal, 3 var) | 1 | 3 (stock 6) | ⚠️ 0 (CARGA ABIERTA, fotos no subidas) | 1 | 🟡 Producto+variantes aplicados MCP (seed 82, 2026-07-07). **RECETA** rectangular HOMBRE metal, ultra liviano 14,7g, bisagra acero inox. **3 MLAs separados** (var_code NULL): C2 negro mate 840071 MLA1878532277 (primary); C1 marrón 840070 MLA1878532279; C3 gris oscuro 840072 MLA1878519921. $72.999 c/u, stock 2. SKUs del founder. `frame_shape="rectangular"`. Medidas 144/54×41/19/140. **NO bluecut**. **SEO+catalog-loader** (norma; primaria `anteojos rusty hombre` 390, único rectangular masculino; cross-link ↔Ther/R-CY02/Woxi). ⬜ Founder: subir 7 fotos a `rusty-invig-receta/` (vacío) + confirmar colores C1 BLUE/C3 PLATEADO vs ML marrón/gris + hero C2. Scale 1.1/1.0 provisional al subir. |
