...
| Rusty: Dapper (G-Flex, unisex, 4 variantes) | 1 | 4 (stock 5; 2 con stock) | 9 (HTTP 200) | 1 | ✅ Aplicado MCP (seed 42). 1 pol (SBLK) → `lens_treatment ["uv400"]`. Precio/stock vía ml-import-preview prod. Primary=SBH/6208 perfil. Founder: confirmar forma (redondo?) + chequear grid/scale. |
