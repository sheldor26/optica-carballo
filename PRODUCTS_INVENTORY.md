...
| Rusty: Blinded (redondo unisex sol, 2 var) | 1 | 2 (stock 8; MDEMI en 0) | 5 (⚠️ fotos NO subidas) | 1 | 🟡 Seed 68 APLICADO MCP (2026-06-13) — **carga ABIERTA**: faltan 4 fotos en `rusty-blinded/` + scale a confirmar. **SOL REDONDO** unisex liviano 22,7g, G-Flex, antirreflejo interior (las 2). **2 MLAs separados**. NINGUNA polarizada. MBLK/S10 129103 $73.661 stock 8 (primary); MDEMI-MBLK/BROWN 129105 $73.957 stock 0 paused (carey). `frame_shape="round"`. Medidas 130/48×43/22/145. **SEO+catalog-loader** (norma). Scale 1.15/1.0 prov. ⬜ Founder: subir fotos + confirmar SKU 129105 (escribió 29105) + MDEMI no discontinuada. |
