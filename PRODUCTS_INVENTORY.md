...
| Vulk: Strewn RECETA (cuadrado femenino transparente, 3 var) | 1 | 3 (stock 6) | 7 (HTTP 200) | 1 | ✅ Aplicado MCP + PDP live (seed 81, 2026-07-07). **RECETA** cuadrado FEMENINO small, G-Flex + bisagras flexo, lentes demo, 17,8g. **3 MLAs separados** (var_code NULL): MBLK negro mate MLA1878507183 (primary); CRY transparente MLA1878518671; M.ROSE rosa transp. MLA1878507185. $80.190 c/u, stock 2. **⚠️ SKU placeholders STREWN-MBLK/CRY/MROSE** (ML sin SKU, founder no los pasó; sync usa item_id). `frame_shape="cuadrado"`. Medidas 134/50×45/18/145. **SEO+catalog-loader** (norma; primaria `anteojos transparentes mujer` 390, NO forma → anti-canib. vs Katleen que es el carril cuadrados-mujer; cross-link Strewn↔Katleen). Fotos bucket `vulk-strewn-receta/` (founder renombró la carpeta mid-carga). Scale **2 familias**: MBLK/MROSE 1.1/1.0 (900×442); CRY 1.2/1.05 (5365×3577). ⬜ Founder: 3 SKUs reales + reverificar scale CRY en grid. |
