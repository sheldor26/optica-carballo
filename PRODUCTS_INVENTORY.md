...
| Rusty: Beason (cat eye femenino, 4 variantes) | 1 | 4 (stock 19) | 8 (HTTP 200; S.PINK/G.BROWN sin foto) | 1 | ✅ Aplicado MCP (seed 44). Ninguna pol → `lens_treatment ["uv400"]`. gender=female, cat_eye. Primary=L.PINK perfil. Founder: subir fotos S.PINK/G.BROWN + chequear grid. |
