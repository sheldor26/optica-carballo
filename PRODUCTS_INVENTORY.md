...
| Rusty: Esvep (envolvente deportivo, 2 de 3 var) | 1 | 2 (stock 12) | 5 (HTTP 200) | 1 | ✅ Aplicado MCP (seed 58, PARCIAL). 2 POL (MBLK/SBLK) → /polarizados + /deportivos. G-Flex, cat 3, 140/60×46/10/130. Primary=MBLK. **3ª var (SBLK no-pol) PENDIENTE: founder pasó SKU duplicado + fotos ambiguas.** Founder: SKU real + chequear scale. |
